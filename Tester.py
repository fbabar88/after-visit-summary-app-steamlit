...
def build_prompt(inputs: dict) -> str:
    ...
    if inputs.get("potassium_status", "Not Reviewed") != "Not Reviewed" or inputs.get("bicarbonate_status", "Not Reviewed") != "Not Reviewed":
        lab_details.append(f"Electrolytes (Potassium: {inputs.get('potassium_status', 'Not Reviewed')}, Bicarbonate: {inputs.get('bicarbonate_status', 'Not Reviewed')})")
    if inputs.get("pth_status", "Not Reviewed") != "Not Reviewed" or inputs.get("vitamin_d_status", "Not Reviewed") != "Not Reviewed":
        lab_details.append(f"Bone Health (PTH: {inputs.get('pth_status', 'Not Reviewed')}, Vitamin D: {inputs.get('vitamin_d_status', 'Not Reviewed')})")
    if lab_details:
...
def main():
    ...
    if mode == "Structured Input":
        ...
        with st.sidebar.expander("Advanced Options"):
            ...
            st.markdown("#### Labs")
            # Instead of a labs review toggle, we directly present lab categories.
            st.markdown("Select lab values (choose 'Not Reviewed' to skip interpretation):")
            # Anemia category
